...
$road_address = esc($shop['RoadAddress'] ?? '');
$full_address = esc($shop['FullAddress'] ?? '');
$address = $road_address ?: $full_address;
    ...
    "@graph":[
      ...
      },
      {
        ...
        "itemListElement":[
          ...
          {"@type":"ListItem","position":2,"name":"안경점 목록","item":"<?= esc($shopsUrl) ?>"},
          {"@type":"ListItem","position":3,"name":"<?= esc($district_name) ?>","item":"<?= esc($districtUrl) ?>"},
          {"@type":"ListItem","position":4,"name":"<?= esc($shopName) ?>","item":"<?= esc($canonicalUrl) ?>"}
        ]
      },
      {
        "@type":"Optician",
...
<div class="container">
  <div class="breadcrumb">
    <a href="<?= site_url() ?>">홈</a> &gt;
    <a href="<?= $shopsUrl ?>">안경점 목록</a> &gt;
    <a href="<?= $districtUrl ?>"><?= esc($district_name) ?></a> &gt;
    상세정보
  </div>
  <h1 class="title"><?= esc($shopName) ?></h1>
  ...
  <div class="grid">
    <div class="card">
      ...
      <div class="kv">
        ...
        <?php if ($shop['BusinessTypeName'] ?? ''): ?><span class="pill"><?= esc($shop['BusinessTypeName']) ?></span><?php endif; ?>
      ...
      <div class="actions">
        ...
        <a class="btn" href="<?= $districtUrl ?>">같은 지역 안경점</a>
        <a class="btn" href="<?= $shopsUrl ?>">안경점 목록</a>
      </div>
    </div>
    <div class="ad">
    ...
    <div class="card">
      <h2>기본 정보</h2>
      <ul class="detail">
        <li class="row"><span class="label">안경점명</span><span class="value"><?= esc($shopName) ?></span></li>
        <li class="row"><span class="label">도로명주소</span><span class="value"><?= $road_address ?></span></li>
        <li class="row"><span class="label">지번주소</span><span class="value"><?= $full_address ?></span></li>
        <li class="row"><span class="label">지역</span><span class="value"><?= $area ?></span></li>
        <li class="row"><span class="label">전화번호</span><span class="value"><?= $phone ?></span></li>
        <li class="row"><span class="label">업종</span><span class="value"><?= esc($shop['BusinessTypeName'] ?? '') ?></span></li>
        <li class="row"><span class="label">우편번호</span><span class="value"><?= esc($shop['PostalCode'] ?? '') ?></span></li>
      </ul>
    ...
    <div class="card">
      <h2>장비 및 시설</h2>
      <ul class="detail">
        <li class="row"><span class="label">시력표 수</span><span class="value"><?= esc($shop['EyeChartCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">렌즈 샘플 수</span><span class="value"><?= esc($shop['LensSampleCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">측정 의자 수</span><span class="value"><?= esc($shop['MeasurementChairCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">동공거리 측정기 수</span><span class="value"><?= esc($shop['PupilDistanceMeterCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">자동굴절계 수</span><span class="value"><?= esc($shop['AutoRefractometerCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">연마기 수</span><span class="value"><?= esc($shop['LensGrinderCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">커터 수</span><span class="value"><?= esc($shop['LensCutterCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">히터 수</span><span class="value"><?= esc($shop['HeaterCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">안경 세척기 수</span><span class="value"><?= esc($shop['EyeglassCleanerCount'] ?? '') ?></span></li>
        <li class="row"><span class="label">총 면적 (㎡)</span><span class="value"><?= esc($shop['TotalArea'] ?? '') ?></span></li>
      </ul>
    </div>
    <div class="ad">
      <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-6686738239613464" data-ad-slot="1204098626" data-ad-format="auto" data-full-width-responsive="true"></ins>
    ...
    <div class="card" id="nearbySection">
      ...
      <?php if (!empty($nearby_shops)): ?>
        <div class="near-grid">
          <?php foreach ($nearby_shops as $n): ?>
            <?php
              $nName = esc($n['BusinessName'] ?? '안경점');
              $nUrl  = esc($n['url'] ?? '#');
              $nRoad = esc($n['RoadAddress'] ?? '');
              $nFull = esc($n['FullAddress'] ?? '');
              $addr  = $nRoad ?: $nFull;
            ?>
            <div class="near-item">
      ...
      <?php else: ?>
        <p class="note">
          가까운 안경점을 찾지 못했습니다. <a href="<?= $districtUrl ?>"><?= esc($district_name) ?> 안경점 목록</a>에서 더 찾아보세요.
        </p>
      <?php endif; ?>
    </div>
    <div class="ad">
