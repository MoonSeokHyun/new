...
<head>
  ...
  <meta name="description" content="퐁퐁코리아 커뮤니티 게시판은 종료되었습니다. 글 작성 기능은 더 이상 제공되지 않습니다.">
  <style>
    ...
    .cta { margin-top:24px; display:inline-block; padding:12px 18px; background:#62D491; color:#fff; text-decoration:none; border-radius:10px; font-weight:bold; }
  </style>
</head>
<body>
  <div class="gone-wrap">
    <h1>게시판 서비스가 종료되었습니다</h1>
    <p>커뮤니티 글 작성 기능은 더 이상 제공되지 않습니다.</p>
    <a class="cta" href="/">홈으로 이동</a>
  </div>
